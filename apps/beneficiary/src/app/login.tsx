...
import BeneficiaryBg from '../assets/imgs/beneficiary bg.png';
  ...
  return (
    <div>
      <div className="flex justify-center h-screen bg-gray-100">
        <div className="w-1/2 flex flex-col justify-between h-5/6">
          ...
          <div className="flex justify-around mb-4 h-full flex-col px-32 py-20">
